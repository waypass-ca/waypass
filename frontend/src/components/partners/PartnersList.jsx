        ...
        <div className="flex items-center gap-2.5">
          {crm.logoUrl ? (
            <img
              src={crm.logoUrl}
              alt=""
              className="w-7 h-7 rounded object-contain border border-line bg-white shrink-0"
            />
          ) : (
            <div className="w-7 h-7 rounded border border-line bg-canvas flex items-center justify-center shrink-0">
