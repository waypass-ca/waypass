        ...
        <div className="flex-1 overflow-hidden bg-[#f0f0f0]">
          {!doc.url ? (
            <div className="w-full h-full flex flex-col items-center justify-center gap-3 px-8 text-center">
              ...
              <p className="font-sans text-[14px] font-medium text-ink">{fileName}</p>
              <p className="font-sans text-[12.5px] text-secondary">{doc.case}</p>
              <p className="font-sans text-[12px] text-muted mt-1">This document was not uploaded to storage — no preview available.</p>
            </div>
          ) : isPdf ? (
            <iframe
