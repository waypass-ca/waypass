...
export function SuccessScreen({ caseId }) {
  return (
    <div className="flex flex-col items-center text-center py-16 px-4">
      {/* Dove icon */}
      <div className="w-16 h-16 rounded-full bg-primary-light flex items-center justify-center text-2xl mb-6">
        🕊
      </div>
      ...
      {/* Body */}
      <p className="font-sans text-sm text-secondary mt-4 max-w-sm leading-relaxed">
      ...
      {/* Case ID badge */}
      <div className="mt-6">
        <Badge variant="warning">Case #{caseId}</Badge>
      </div>
      ...
      <p className="font-sans text-xs font-medium text-ink mt-1">
        (415) 555-0190
      </p>
    </div>
  )
