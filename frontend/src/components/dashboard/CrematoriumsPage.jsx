...
import { AddPartnerModal, DisconnectModal } from './partners/Modals.jsx'
import { PartnerDetailPage } from './partners/PartnerDetailPage.jsx'
import { PartnersList } from './partners/PartnersList.jsx'
import { NearbyDiscovery } from './partners/NearbyDiscovery.jsx'
...
export function CrematoriumsPage({ onAddPartner, cases = [], onViewCase }) {
  ...
  // Keep selectedPartner in sync when crematoriums list updates
  useEffect(() => {
