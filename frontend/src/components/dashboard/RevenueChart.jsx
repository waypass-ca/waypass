  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="bg-warm-white rounded-xl p-6 border border-border">
        ...
        <p className="font-display text-2xl text-charcoal mt-1">2024 Overview</p>
        ...
        <div className="flex items-end gap-4 mt-6" style={{ height: '120px' }}>
          {BAR_DATA.map(bar => (
            <div key={bar.month} className="flex-1 flex flex-col items-center gap-2 h-full justify-end">
              ...
              <div
                className="w-full rounded-t-md bg-sage opacity-80 hover:opacity-100 transition-opacity"
      ...
      <div className="bg-warm-white rounded-xl p-6 border border-border">
        ...
        <p className="font-display text-4xl font-light text-charcoal mt-2">$18,575</p>
        ...
        <div className="mt-6 pt-5 border-t border-border space-y-3">
          <div className="flex justify-between">
            ...
            <span className="font-sans text-xs font-medium text-charcoal">31 YTD</span>
          </div>
          <div className="flex justify-between">
            <span className="font-sans text-xs text-muted">Avg. margin per case</span>
            <span className="font-sans text-xs font-medium text-charcoal">$599</span>
          </div>
          <div className="flex justify-between">
            <span className="font-sans text-xs text-muted">Avg. turnaround</span>
            <span className="font-sans text-xs font-medium text-charcoal">2.4 days</span>
          </div>
        </div>
      </div>
    </div>
