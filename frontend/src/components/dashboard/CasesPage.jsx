...
// ─── Case context menu ────────────────────────────────────────────────────────
function CaseMenu({ c, onViewCase, userFolders, onMoveToFolder, onCreateAndMove, up = false }) {
  ...
  return (
    <div ref={ref} className="relative" onClick={e => e.stopPropagation()}>
      <button
        ...
        className={`w-6 h-6 rounded-md flex items-center justify-center text-muted cursor-pointer transition-colors ${open ? 'bg-canvas text-ink' : 'hover:bg-canvas'}`}>
